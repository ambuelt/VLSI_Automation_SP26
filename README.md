...
|
├── output_physical/
│   └── p7_final_output/  <- Moved into this folder manually for ease of grading
...
│   └── exp_fixed_point/
|       └── Contains iVerilog & OpenROAD output from Codex CLI
│       ├── iteration_#.logs of automated run_codex.py script
|
|
├── eda_agent/
...
The expected results of all visible problems are located in the different *_final_ouput folders under output_physical folder
